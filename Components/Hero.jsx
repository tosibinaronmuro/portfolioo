...
function Hero() {
  ...
  return (
    <div className='h-full  '> 
       ...
       <div className='flex flex-col lg:flex-col p-4  w-full h-screen bg-transparent    '  >
{/* home */}
...
{/* contact */}
<Link href="/#contact"   scroll={true}><div onClick={() => setActiveNav('#contact')} className={activeNav === '#contact' ?  styles.active : styles.logo}>
