  ...
  return (
    <>
      ...
      <Drawer
        ...
        key={placement}
      >
         <div className='flex flex-col p-4  w-full h-screen bg-none    '  >
{/* home */}
...
<svg class="w-6 h-6  " fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg><span className='ml-5'>ABOUT ME</span>
</div></Link>

{/* SKILLS */}
<Link href="/#skills"   scroll={true}><div   className='bg-black flex text-white rounded-full w-auto h-auto border shadow-md  my-5 p-2  justify-start'>
