  ...
  return (
    <>
      ...
      <Drawer
        ...
        key={placement}
      >
         <div className={themee.light? styles.drawer2 : styles.drawer}  >
{/* home */}
<Link href="/#home"   scroll={false}><div onClick={onClose} className='bg-black flex text-white rounded-full w-auto h-auto border shadow-md border-yellow-500  my-5 p-2  justify-start'>
<svg className="w-6 h-6  " fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg><span className='ml-5'>HOME</span>
</div></Link>

{/* about */}

<Link href="/#about"   scroll={true}><div onClick={onClose} className='bg-black flex text-white rounded-full w-auto h-auto border shadow-md border-yellow-500  my-5 p-2  justify-start'>
...
{/* SKILLS */}
<Link href="/#skills"   scroll={true}><div onClick={onClose}  className='bg-black flex text-white rounded-full w-auto h-auto border shadow-md border-yellow-500  my-5 p-2  justify-start'>
...
<Link href="/#projects"   scroll={true}><div onClick={onClose} className='bg-black flex text-white rounded-full w-auto h-auto border shadow-md border-yellow-500  my-5 p-2  justify-start'>
...
<Link href="/#contact"   scroll={true}><div onClick={onClose} className='bg-black flex text-white rounded-full w-auto h-auto border shadow-md border-yellow-500  my-5 p-2  justify-start'>
