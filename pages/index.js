...
<Cursor/>
      ...
      <div className={styles.cube}></div>
          ...
          <div  className=" mx-5 md:ml-40 lg:ml-40  text-gray-300 m-auto flex flex-col justify-center items-start">
            <h1 className="text-3xl flex flex-col text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-yellow-800  justify-start font-mono font-bold items-center">
